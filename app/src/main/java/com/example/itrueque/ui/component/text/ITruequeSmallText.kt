...
@Composable
fun ITruequeSmallText(modifier: Modifier = Modifier, text: String, color: Color = TurquoiseBlack) {
    Text(text = text, modifier = modifier, fontSize = 16.sp, color = color)
}

@Preview
@Composable
fun ITruequeSmallTextPreview() {
    ITruequeSmallText(text = stringResource(id = R.string.app_name))
}